...
# Copy from container
docker cp patent-pipeline:/app/AI_pipeline/google_sheets_integration/local_setup/generate_oauth_token.py .
...
# Verify it's there
docker exec patent-pipeline ls -la /app/AI_pipeline/google_sheets_integration/oauth_token.json
```
